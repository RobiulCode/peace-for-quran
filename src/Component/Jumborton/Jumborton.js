...
const Jumborton = ({handleSearch}) => {
    return (
        <div className='bg-blue-300 flex flex-col justify-center items-center py-6 h-40 md:h-72 bg-center bg-cover bg-no-repeat' style={{ 
            ...
            <div>
                ...
                <div className="flex flex-col md:flex relative items-center w-96">
